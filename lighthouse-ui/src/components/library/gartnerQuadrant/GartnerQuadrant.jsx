import dummyQuadrantData from "../../../dummyData/dummyQuadrantData";
import DataPoints from "./DataPoints";
import QuadrantLabels from "./QuadrantLabels";
import QuadrantLines from "./QuadrantLines";

export default function GartnerQuadrant({ xAxisLabel, yAxisLabel }) {
  return (
    <div className="relative w-full max-w-xl  aspect-square">
      <QuadrantLines />
      <QuadrantLabels />
      <DataPoints dataPoints={dummyQuadrantData} />
