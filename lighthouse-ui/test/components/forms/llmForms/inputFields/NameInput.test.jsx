...
import NameInput from "../../../../../src/components/forms/llmForms/modal/inputFields/NameInput";
...
describe("Name input field tests: ", () => {
  ...
  describe("Failed validation tests: ", () => {
    beforeEach(() => {
      ModalDetailsValidator.validateName = vi.fn();
      ModalDetailsValidator.validateName.mockReturnValue([
        false,
        testErrorMessage,
      ]);
    });
    ...
    describe("Validation activated tests: ", () => {
      ...
      //? TEST:
      test("It should display an error on blur name is invalid", async () => {
        //Act
    ...
    describe("Validation deactivated tests: ", () => {
      ...
      //? TEST:
      test("It should not display an error on blur where name is invalid but do skip validation is set to true", async () => {
        //Act
        const inputField = screen.getByTitle(testLabel);
        await act(async () => {
          inputField.focus();
  ...
  describe("Successful validation tests: ", () => {
    beforeEach(() => {
      ModalDetailsValidator.validateName = vi.fn();
      ModalDetailsValidator.validateName.mockReturnValue([true]);
      render(
        <NameInput
          nameValue={testValue}
          label={testLabel}
    ...
    //? TEST:
    test("It should not display an error on blur where name is valid", async () => {
      //Act
      const inputField = screen.getByTitle(testLabel);
      await act(async () => {
        inputField.focus();
