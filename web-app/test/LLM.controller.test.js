...
describe("LLM Controller", () => {
    ...
    describe("getLLMCount", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(LLMService, "getLLMCount").rejects(new Error("Service failure"));
    ...
    describe("getAllLLMs", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(LLMService, "getAllLLMs").rejects(new Error("Service failure"));
    ...
    describe("getLLMById", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(LLMService, "getLLMById").rejects(new Error("Service failure"));
