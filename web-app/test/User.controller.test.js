...
describe("User Controller", () => {
    ...
    describe("createUser", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(UserService, "createUser").rejects(new Error("Service failure"));
    ...
    describe("getUserByEmail", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(UserService, "getUserByEmail").rejects(new Error("Service failure"));
    ...
    describe("loginUser", () => {
        ...
        it("should return 500 on service failure", async () => {
            sinon.stub(UserService, "loginUser").rejects(new Error("Service failure"));
